...
idx = cross_val(X, y, cv=5, epochs=30, M=10, N=10, grid = "hexagonal", verbose=False, save_path='som_snapshots/net10x10/hex/human_som')
# save the indices
np.save('som_snapshots/net10x10/human_som_hex_idx.npy', idx)


idx = cross_val(X, y, cv=5, epochs=30, M=25, N=25, grid = "hexagonal", verbose=False, save_path='som_snapshots/net25x25/hex/human_som')
np.save('som_snapshots/net25x25/human_som_hex_idx.npy', idx)
